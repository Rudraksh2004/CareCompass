    ...
    <div className="min-h-screen flex items-center justify-center px-6 py-12 relative overflow-hidden bg-gradient-to-br from-white via-emerald-50/20 to-indigo-50/10 dark:from-[#020617] dark:via-[#051814] dark:to-[#020814] text-gray-900 dark:text-gray-100 transition-all duration-700">
      ...
      <div className="absolute inset-0 -z-10 bg-[#f8fafc] dark:bg-[#020617] transition-colors duration-1000">
        ...
        <div className="absolute inset-0 overflow-hidden opacity-70 dark:opacity-50">
          <div className="absolute top-[-20%] left-[-10%] w-[100%] h-[100%] rounded-full bg-emerald-400/25 dark:bg-emerald-600/15 blur-[130px] animate-fluid-mesh" />
          <div className="absolute bottom-[-20%] right-[-10%] w-[90%] h-[120%] rounded-full bg-blue-400/20 dark:bg-blue-600/10 blur-[120px] animate-fluid-mesh [animation-delay:4s]" />
