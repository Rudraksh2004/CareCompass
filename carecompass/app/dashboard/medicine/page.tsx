        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
          ...
          <div className="flex flex-wrap gap-4">
             <div className="px-8 py-5 rounded-[2rem] bg-white/40 dark:bg-white/5 border border-white/60 dark:border-white/[0.05] backdrop-blur-md flex flex-col items-center">
                <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2">Analysis Depth</p>
        ...
        <div className="flex items-center justify-center gap-10 md:gap-16 relative">
          {[1, 2].map((s) => (
            <button key={s} onClick={() => s < step && setStep(s)} className={`relative flex flex-col items-center gap-4 group cursor-default`}>
               ...
               <span className={`text-[9px] font-black uppercase tracking-widest transition-colors ${step === s ? "text-purple-600" : "text-gray-500"}`}>
                Phase 0{s}
              </span>
            </button>
          ))}
            ...
            {step === 1 && (
              <div className="space-y-12 animate-in fade-in slide-in-from-bottom-10 duration-700">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-500 font-bold max-w-lg mx-auto">Upload a prescription image, PDF, or manually type the medicine name to begin synthesis.</p>
                </div>
                  ...
                  <div className="flex flex-col gap-4">
                    ...
                    <div className="relative h-[200px] group overflow-hidden rounded-3xl border-2 border-dashed border-gray-300 dark:border-gray-700 bg-white/40 dark:bg-white/5 transition-all hover:bg-white/60 dark:hover:bg-white/10 flex flex-col items-center justify-center">
                       ...
                       <div className="relative z-10 flex flex-col items-center gap-4">
                          ...
                          <span className="text-sm font-black text-gray-700 dark:text-gray-300 italic">Drop Prescription here</span>
                       </div>
                    </div>
                  </div>
                </div>
            ...
            {step === 2 && (
              <div className="space-y-10 animate-in fade-in slide-in-from-bottom-10 duration-700">
                 <div className="space-y-3">
                    ...
                    <p className="text-gray-500 font-bold ml-5">Confirm the extracted medicine name or instructions before AI synthesis.</p>
                 </div>
                 ...
                 <div className="flex gap-4">
                    <button onClick={() => setStep(1)} className="px-12 py-5 rounded-2xl font-black border border-gray-300 dark:border-white/10 hover:bg-white/10 transition-all font-black text-gray-600">RE-INPUT</button>
         ...
         <div className="relative border border-white/80 dark:border-white/[0.05] bg-white/[0.6] dark:bg-[#030712]/30 backdrop-blur-[60px] p-32 rounded-[4rem] text-center space-y-12">
            ...
            <div className="space-y-6">
               ...
               <div className="flex items-center justify-center gap-3">
                  ...
                  <span className="text-xs font-black text-gray-400 uppercase tracking-widest ml-4">Generating Pharmacological Profile</span>
               </div>
            </div>
         </div>
      )}
            ...
            <div className="relative z-10 space-y-12">
              <div className="flex flex-col md:flex-row justify-between gap-8 border-b border-gray-100 dark:border-white/5 pb-12">
                <div className="space-y-2">
                  ...
                  <p className="text-sm font-bold text-gray-500 uppercase tracking-widest">Medicine: <span className="text-gray-900 dark:text-white">{medicineText}</span></p>
                </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div className="p-8 rounded-[2rem] bg-white/50 dark:bg-white/[0.02] border border-white/80 dark:border-white/5 flex flex-col items-center gap-2">
                   ...
                   <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Analysis Type</span>
                   <span className="text-sm font-black text-gray-900 dark:text-white text-center italic">Therapeutic Action</span>
                </div>
                <div className="p-8 rounded-[2rem] bg-white/50 dark:bg-white/[0.02] border border-white/80 dark:border-white/5 flex flex-col items-center gap-2">
                   <Clock className="text-emerald-500" size={20} />
                   <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Synthesis Time</span>
                   <span className="text-sm font-black text-gray-900 dark:text-white text-center italic">~3.2 Seconds</span>
                </div>
                <div className="p-8 rounded-[2rem] bg-white/50 dark:bg-white/[0.02] border border-white/80 dark:border-white/5 flex flex-col items-center gap-2">
                   <AlertTriangle className="text-amber-500" size={20} />
                   <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Caution Index</span>
                ...
                <div className="p-8 rounded-[2rem] bg-white/50 dark:bg-white/[0.02] border border-white/80 dark:border-white/5 flex flex-col items-center gap-2">
                   ...
                   <span className="text-[10px] font-black uppercase tracking-widest text-gray-400">Clinical Focus</span>
              ...
              <div key={item.id} className="relative group border border-white/80 dark:border-white/[0.05] bg-white/[0.4] dark:bg-white/[0.02] backdrop-blur-2xl p-8 rounded-[2.5rem] transition-all hover:bg-white hover:scale-[1.03] hover:shadow-2xl dark:hover:bg-white/10">
                <div className="flex flex-col h-full">
                  ...
                  <div className="mb-8 flex-1">
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Snippet</p>
                    <div className="text-xs font-bold text-gray-600 dark:text-gray-400 line-clamp-3 leading-relaxed">
