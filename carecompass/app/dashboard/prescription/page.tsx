      ...
      <div className="relative group overflow-hidden rounded-[2rem] md:rounded-[2.5rem] border border-white/80 dark:border-white/[0.05] bg-white/[0.4] dark:bg-[#030712]/30 backdrop-blur-[60px] p-6 md:p-12 transition-all duration-700 hover:shadow-2xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-10">
          <div className="space-y-4">
            <div className="flex items-center gap-3 md:gap-4">
              <div className="p-3 md:p-4 rounded-[1.2rem] md:rounded-[1.5rem] bg-gradient-to-br from-indigo-600 to-purple-600 text-white shadow-xl shadow-indigo-500/20">
                <FileSearch className="w-6 h-6 md:w-8 md:h-8" strokeWidth={2.5} />
              </div>
          ...
          <div className="flex flex-wrap gap-4">
             <div className="px-6 py-4 md:px-8 md:py-5 rounded-[1.5rem] md:rounded-[2rem] bg-purple-500/10 border border-purple-500/20 backdrop-blur-md flex flex-row md:flex-col items-center gap-3 md:gap-0">
                <BrainCircuit className="text-purple-500 md:mb-2" size={20} />
                <div className="flex flex-col md:items-center">
                   <span className="text-[10px] font-black uppercase tracking-widest text-purple-500 leading-none">Neural Sync</span>
                   <span className="text-lg md:text-xl font-black mt-1 leading-none">OCR ACTIVE</span>
                </div>
             </div>
          </div>
        </div>
          ...
          <div className="relative group overflow-hidden rounded-[2rem] md:rounded-[3rem] border border-white/60 dark:border-white/[0.05] bg-white/[0.3] dark:bg-[#030712]/30 backdrop-blur-[60px] p-6 md:p-8 shadow-xl transition-all">
            <div className="relative z-10 space-y-8">
              <div className="flex items-center gap-3">
                ...
                <h2 className="text-xl md:text-2xl font-black tracking-tighter">Clinical Intake</h2>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <div className="relative group/upload border-2 border-dashed border-indigo-500/20 dark:border-white/10 rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-10 text-center hover:bg-indigo-500/5 dark:hover:bg-white/5 transition-all cursor-pointer overflow-hidden">
                    <input
                      type="file"
                    ...
                    <div className="relative z-10 space-y-3">
                       <UploadCloud className="mx-auto text-indigo-500 group-hover/upload:scale-110 transition-transform w-8 h-8 md:w-10 md:h-10" />
                       <div className="font-black text-xs md:text-sm uppercase tracking-widest">INGEST SCAN</div>
                       <p className="text-[8px] md:text-[10px] font-bold text-gray-600 dark:text-gray-400 italic">Supports Scanned PDFs & JPEGs</p>
                    </div>
                  </div>
                  {fileLoading && (
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/40 dark:bg-black/40 border border-white/80 dark:border-white/10 p-4 md:p-6 rounded-[1.5rem] md:rounded-[2rem] font-bold outline-none focus:ring-4 focus:ring-indigo-500/10 transition-all text-xs leading-relaxed"
        ...
        <div className="lg:col-span-2 space-y-10">
          {!result ? (
            <div className="relative group overflow-hidden rounded-[2.5rem] md:rounded-[3.5rem] border border-white/80 dark:border-white/[0.05] bg-white/[0.4] dark:bg-[#030712]/30 backdrop-blur-[60px] p-10 md:p-20 flex flex-col items-center justify-center text-center space-y-6 md:space-y-8 h-full min-h-[400px] md:min-h-[500px]">
              <div className="w-24 h-24 md:w-32 md:h-32 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-300">
                 <Stethoscope className="w-12 h-12 md:w-16 md:h-16" strokeWidth={1} />
              </div>
              <div className="space-y-2">
                <h3 className="text-xl md:text-2xl font-black tracking-tighter text-gray-600 dark:text-gray-400 italic">Awaiting Regimen Synthesis</h3>
                <p className="text-[10px] md:text-xs font-bold text-gray-700 dark:text-gray-500 max-w-xs uppercase tracking-widest leading-loose">Upload a prescription to generate a simplified medical translation matrix.</p>
              </div>
            </div>
          ) : (
            <div className="relative animate-in slide-in-from-right-12 duration-700 bg-white/[0.7] dark:bg-[#030712]/50 backdrop-blur-[80px] border border-white/80 dark:border-indigo-500/20 rounded-[2.5rem] md:rounded-[3.5rem] p-6 md:p-12 shadow-3xl overflow-hidden group/result">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start gap-6 border-b border-gray-100 dark:border-white/5 pb-6 md:pb-10">
                   <div className="space-y-3">
                      <div className="flex items-center gap-3">
                         ...
                         <h2 className="text-2xl md:text-3xl font-black tracking-tighter">Deciphered Matrix</h2>
                      </div>
      ...
      {history.length > 0 && (
        <div className="space-y-8">
          <div className="flex items-center gap-4 px-2 md:px-6">
             ...
             <h2 className="text-2xl md:text-3xl font-black tracking-tighter">Historical Registry</h2>
          </div>
                ...
                <div key={item.id} className={`relative group border transition-all duration-500 rounded-[2rem] md:rounded-[3rem] p-6 md:p-10 overflow-hidden ${isExpanded ? "md:col-span-2 lg:col-span-3 bg-white/80 dark:bg-white/5 border-indigo-500/30 shadow-2xl" : "bg-white/[0.4] dark:bg-[#030712]/30 border-white/80 dark:border-white/5 hover:bg-white/60 dark:hover:bg-white/10 shadow-xl"}`}>
                  <div className="relative z-10 space-y-4 md:space-y-6">
                    <div className="flex justify-between items-center">
                       ...
                       <button onClick={() => handleDelete(item.id)} className="p-2 md:p-3 rounded-xl md:rounded-2xl bg-red-500/5 text-red-500 border border-red-500/10 hover:bg-red-500 hover:text-white transition-all">
                          <Trash2 size={16} />
                       </button>
                    </div>
